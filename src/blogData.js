/* --------------------------------------------------------------------------
   BLOG DATABASE - NANAK TECH SOLUTIONS
   Topical authority content following Google EEAT principles
   -------------------------------------------------------------------------- */

export const blogData = {
  "future-ai-automation-modern-businesses": {
    ...
    faqs: [
      {
        q: "What security measures protect customer data in AI pipelines?",
        a: "We encrypt all data in transit and at rest, utilize secure OAuth2 credentials protocols, deploy pipelines inside private Virtual Private Clouds (VPCs), and enforce SOC2 compliance guidelines."
      },
      {
        q: "How long does it take to integrate custom AI agents?",
